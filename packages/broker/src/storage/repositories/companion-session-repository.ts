...
import { companionHeartbeatSchema, companionRegistrationAckSchema } from "@ai-whisper/shared";
...
export function updateCompanionHeartbeat(
  db: Database.Database,
  input: { collabId: string; sessionId: string; healthState: "healthy" | "degraded" | "offline"; sentAt: string },
): void {
